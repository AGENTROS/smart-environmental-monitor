...
1. **Boot Initialization**:
   ...
   - The firmware attempts connection using locally configured Wi-Fi credentials.
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **TC-001** | WiFi Connection | Valid local credentials | Successful connection, LCD prints IP Address | Successfully connected and displayed an IP address | **PASSED** |
